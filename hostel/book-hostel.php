						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-primary">
									<div class="panel-heading">Semua Info</div>
...
<div class="form-group">
<label class="col-sm-2 control-label">Kamar No. </label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Bangku</label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Biaya Per Bulan</label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Status Makan</label>
<div class="col-sm-8">
<input type="radio" value="0" name="foodstatus" checked="checked"> Tanpa Biaya Makan
<input type="radio" value="1" name="foodstatus"> Dengan Biaya Makan (IDR 2.000.000 Perbulan(Ekstra))
</div>
</div>	

<div class="form-group">
<label class="col-sm-2 control-label"> Menetap Dari </label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Jumlah sTotal</label>
<div class="col-sm-8">
