			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Tambah Kursus </h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Tambah Kursus</div>
									<div class="panel-body">
										<form method="post" class="form-horizontal">
											
											<div class="hr-dashed"></div>
											<div class="form-group">
												<label class="col-sm-2 control-label">Kode Kursus </label>
												<div class="col-sm-8">
													<input type="text" value="" name="cc"  class="form-control"> </div>
											</div>
											<div class="form-group">
												<label class="col-sm-2 control-label">Nama Kursus (Pendek)</label>
												<div class="col-sm-8">
...
<div class="form-group">
									<label class="col-sm-2 control-label">Nama Kursus(Lengkap)</label>
									<div class="col-sm-8">
